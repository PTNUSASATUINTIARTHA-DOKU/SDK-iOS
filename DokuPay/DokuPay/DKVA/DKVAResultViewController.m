...
@interface DKVAResultViewController ()

@end

@implementation DKVAResultViewController
...
//    [[[DokuPay sharedInstance] navController] dismissViewControllerAnimated:YES completion:nil];
    ...
    [[[DokuPay sharedInstance] delegate] dismissViewControllerAnimated:YES completion:nil];
}
