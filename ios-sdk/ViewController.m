...
#define URL_CHARGING_DOKU_DAN_CC @"https://sandboxenv.com/doku-library/example-payment-mobile/merchant-example.php"
#define URL_CHARGING_MANDIRI_CLICKPAY @"https://sandboxenv.com/doku-library/example-payment-mobile/merchant-example.php"

// production MAP

 #define MerchantSharedKey @"ah4lzzoNphxX"
 #define MerchantSharedMallID @"9509"
 #define MerchantPublicKey @""
...
-(DKPaymentItem*)getPaymentItem
{
    ...
    paymentItem.dataEmail =@"JohnDoe@johndoe.com";
    ...
    paymentItem.mobilePhone = @"081111111111";
